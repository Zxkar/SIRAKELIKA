...
// SESUAIKAN path ini dengan lokasi folder upload bukti yang sebenarnya di server kamu.
// buat_laporan.php menyimpan ke 'uploads/bukti/' relatif terhadap folder tempat ia berada.
